/*!
Copyright (c) 2016 Dominik Moritz original version
Copyright (c) 2021 Danilo Santitto current Capacitor version
...
(function (factory, window) {
    ...
    var LocateControl = L.Control.extend({
            ...
            if (this._event &&
                (this._event.latlng.lat === e.coords.latitude &&
                 this._event.latlng.lng === e.coords.longitude &&
                     this._event.accuracy === e.coords.accuracy)) {
                return;
            }
        ...
        _setEvent: function(latitude, longitude, accuracy) {
            this._event = {
                "latlng": {
                    "lat": latitude,
                    "lng": longitude,
